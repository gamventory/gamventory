...
//                 // In case of StaleElementReferenceException, re-fetch the elements
//                 gameNames = driver.findElements(By.YOUR_SELECTOR_FOR_GAME_NAMES);
//                 gamePrices = driver.findElements(By.YOUR_SELECTOR_FOR_GAME_PRICES);
//                 gameImages = driver.findElements(By.YOUR_SELECTOR_FOR_GAME_IMAGES);
//                 itemDetails = driver.findElements(By.YOUR_SELECTOR_FOR_ITEM_DETAILS);

//                 // After re-fetching, print the details again
//                 System.out.println("Game Name: " + gameNames.get(i).getText());
//                 System.out.println("Game Price: " + gamePrices.get(i).getText().strip());
//                 System.out.println("Game Image: " + gameImages.get(i));
//                 System.out.println("Item Detail: " + itemDetails.get(i));
