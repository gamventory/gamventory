...
@Service
public class NintendoGamesScraper {
    ...
    // Platform enum 랜덤값 console에 있는것들만 가져오는 메서드
    ...
    public List<ItemFormDto> scrapeNintendoGames() {
        ...
        try {
            ...
            List<WebElement> gameNames = driver.findElements(By.cssSelector("a.category-product-item-title-link"));
            List<WebElement> gamePrices = driver.findElements(By.cssSelector("span.price"));
            List<WebElement> gameImages = driver.findElements(By.cssSelector("img.product-image-photo"));
            ...
            for (int i = 0; i < gameNames.size(); i++) {
                ...
                itemFormDto.setPlatform(Platform.NINTENDO);
                itemFormDto.setGameKind(GameKind.CONSOLE);
